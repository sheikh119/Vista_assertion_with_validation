...
module vert_formal_wrap;
  ...
  logic [31:0] sig_5;
  logic [31:0] tx_6;
  always @(posedge posedge core_clock_8) begin
...
endcase
  ...
  always @* begin
    assert (((!(@(posedge core_clock_8) ( interrupt_enable_9 ) == ( 7'h7e ) && ( tx_6 || data_6 != reg_3 && fsm_1 ))) || (reg_6 == chip_12 && hw_5 == auth_17 && chip_8 == hw_9)));
  end
endmodule
