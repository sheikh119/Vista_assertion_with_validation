...
endcase
  ...
  always @* begin
    assert (((!(@(posedge clock_div_15) ( data_register_18 ) == ( fsm_20 ) && ( cfg_13 != rst_4 || reg_6 ))) || (sig_20 == rst_8)));
    assert (((!(@(posedge clock_div_15) ( data_register_18 ) == ( fsm_20 ) && ( cfg_13 != rst_4 || reg_6 ) && ( fsm_18 && rx_9 != sig_13 && sig_6 ))) || (fsm_6 == core_7)));
  end
endmodule
