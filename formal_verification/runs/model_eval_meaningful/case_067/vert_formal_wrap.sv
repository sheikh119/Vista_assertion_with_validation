...
module vert_formal_wrap;
  ...
  logic [31:0] tx_11;
  logic [31:0] tx_33;
  always @(posedge posedge core_clock_12) begin
if (  auth_6  && chip_3  || hw_19 ) begin 
  ...
  always @* begin
    assert (((!(@(posedge core_clock_12) ( auth_6 && chip_3 || hw_19 ))) || (chip_1 == clk_5)));
    assert (((!(@(posedge core_clock_12) ( auth_6 && chip_3 || hw_19 ) && ( fsm_10 != chip_16 || fsm_20 ))) || (clk_6 == err_11)));
  end
endmodule
