...
property p_gen_1; ( output_register_status_4 ) == ( 7'b1100x01 ) && ( err_5 != core_7 || sig_22 ) |=> clk_3 == tx_8 ; endproperty
assert property (p_gen_1);
property p_gen_2; ( output_register_status_4 ) == ( 7'b1100x01 ) && ( err_5 != core_7 || sig_22 ) && ( err_8 && fsm_14 && core_18 ) |=> err_6 == hw_10 ; endproperty
