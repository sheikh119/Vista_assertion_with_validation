...
property p_gen_1; @(negedge sys_clk_9) ( fsm_2 || rst_12 && sig_2 ) |-> clk_1 == data_116; endproperty
assert property (p_gen_1);
property p_gen_2; @(negedge sys_clk_9) ( fsm_2 || rst_12 && sig_2 ) && ( err_158 != data_7 ) |-> hw_15 == data_20; endproperty
