...
property p_gen_1; @(posedge clk_reset_7) ( clk_14 != rx_19 || clk_8 ) |-> clk_15 == hw_8; endproperty
assert property (p_gen_1);
property p_gen_2; @(posedge clk_reset_7) ( clk_14 != rx_19 || clk_8 ) && ( cfg_14 != rx_19 || tx_10 != cfg_20 ) |-> core_14 == cfg_3; endproperty
